...
def simulate_F(n):
    samp = np.random.uniform(0, 1, (n, d))
    return (samp[:, :, None] <= x[None, None, :]).mean(axis=1)

# Parameters
np.random.seed(0)
B, N, d, alpha = 500_000, 500_000, 100, 0.05
...
fig1.write_image("Bands_Ecdf.png", scale=2.0)
...
fig2.write_image("Width_Ecdf.png", scale=2.0)
